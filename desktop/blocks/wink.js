...
Blockly.Blocks['ir_control'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("When ")
        .appendField(new Blockly.FieldDropdown([["1", "IR_1"], ["2", "IR_2"], ["3", "IR_3"], ["4", "IR_4"], ["5", "IR_5"], ["6", "IR_6"], ["7", "IR_7"], ["8", "IR_8"], ["9", "IR_9"], ["10", "IR_10"], ["Forward", "IR_Forward"], ["Left", "IR_Left"], ["Right", "IR_Right"], ["Backword", "IR_Backword"], ["Power", "IR_Power"], ["Plum Logo", "IR_PlumLogo"], ["Menu", "IR_Menu"], ["A", "IR_A"], ["B", "IR_B"], ["X", "IR_X"], ["Play", "IR_Play"]]), "BUTTON")
...
Blockly.Blocks['ir_when'] = {
  ...
  compose: function(containerBlock){
    ...
    for(var i = 1; i <= this.keyPressChecks; ++i){
      console.log('Statementconnection %d %o',i,statementConnections[i]);
  ...
  decompose: function(workspace) {
    ...
    var containerBlock = workspace.newBlock('ir_control_container');
    containerBlock.initSvg();

    var connection = containerBlock.nextConnection;
    for(var i = 1; i <= this.keyPressChecks; ++i){
      var keyPressBlock = workspace.newBlock('ir_control_control');
  ...
  updateShape_: function(){
    ...
    var values = [null];
    var input = this.getInput('CHECK' + i);
    ...
    for(var i = 1; i <= this.keyPressChecks; ++i){
      var field = new Blockly.FieldDropdown([["1", "IR_1"], ["2", "IR_2"], ["3", "IR_3"], ["4", "IR_4"], ["5", "IR_5"], ["6", "IR_6"], ["7", "IR_7"], ["8", "IR_8"], ["9", "IR_9"], ["10", "IR_10"], ["Forward", "IR_Forward"], ["Left", "IR_Left"], ["Right", "IR_Right"], ["Backword", "IR_Backword"], ["Power", "IR_Power"], ["Plum Logo", "IR_PlumLogo"], ["Menu", "IR_Menu"], ["A", "IR_A"], ["B", "IR_B"], ["X", "IR_X"], ["Play", "IR_Play"]]);
      if(values[i]){
