...
Blockly.Blocks['lists_split'] = {
  ...
  /**
   * Modify this block to have the correct input and output functionTypes.
  ...
  /**
   * Create XML to represent the input and output functionTypes.
   * @return {!Element} XML storage element.
   * @this Blockly.Block
   */
  mutationToDom: function() {
  ...
  /**
   * Parse XML to restore the input and output functionTypes.
   * @param {!Element} xmlElement XML storage element.
   * @this Blockly.Block
   */
  domToMutation: function(xmlElement) {
