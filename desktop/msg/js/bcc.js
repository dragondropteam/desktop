...
Blockly.Msg.CHECK_COLLISION_TOOLTIP = "Which edges of the World bounds Bodies can collide against when collideWorldBounds is true. For example checkCollision.down = false means Bodies cannot collide with the World.bounds.bottom. An object containing allowed collision flags (up, down, left, right).";  // untranslated
...
Blockly.Msg.COLLISION_GET_OBJECTS_AT_LOCATION_FUNCTION_TOOLTIP = "Given a Group and a location this will check to see which Group children overlap with the coordinates. Each child will be sent to the given callback for further processing. Note that the children are not checked for depth order, but simply if they overlap the coordinate or not.";  // untranslated
...
Blockly.Msg.GET_ANIMATION_BOOLEAN_FIELD_VI_HELP_URL = "https://photonstorm.github.io/phaser-ce/Phaser.Animation.html";  // untranslated
Blockly.Msg.GET_ANIMATION_BOOLEAN_FIELD_VI_TOOLTIP = "Gets the boolean selected from the specified object.";  // untranslated
Blockly.Msg.GET_ANIMATION_NUMERIC_FIELD_HELP_URL = "https://photonstorm.github.io/phaser-ce/Phaser.Animation.html";  // untranslated
...
Blockly.Msg.GET_ANIMATION_STRING_FIELD_HELP_URL = "https://photonstorm.github.io/phaser-ce/Phaser.Animation.html";  // untranslated
...
Blockly.Msg.GET_OBJECTS_UNDER_POINTER_OVERLAP = "that overlap with the mouse";  // untranslated
Blockly.Msg.GET_OBJECTS_UNDER_POINTER_TOOLTIP = "Given a Group and a Pointer this will check to see which Group children overlap with the Pointer coordinates. Each child will be sent to the given callback for further processing. Note that the children are not checked for depth order, but simply if they overlap the Pointer or not.";  // untranslated
...
Blockly.Msg.PHYSICS_ACCELERATE_TO_LOCATION_HELP_URL = "";  // untranslated
Blockly.Msg.PHYSICS_ACCELERATE_TO_LOCATION_TOOLTIP = "";  // untranslated
...
Blockly.Msg.PHYSICS_ACCELERATE_TO_OBJECT_TOOLTIP = "Sets the acceleration.x/y property on the display object so it will move towards the target at the given speed (in pixels per second sq.) You must give a maximum speed value, beyond which the display object won't go any faster. Note: The display object does not continuously track the target. If the target changes location during transit the display object will not modify its course. Note: The display object doesn't stop moving once it reaches the destination coordinates.";  // untranslated
Blockly.Msg.PHYSICS_ACCELERATE_TO_POINTER_HELP_URL = "";  // untranslated
Blockly.Msg.PHYSICS_ACCELERATE_TO_POINTER_TOOLTIP = "";  // untranslated
...
Blockly.Msg.PHYSICS_MOVE_TO_LOCATION_TOOLTIP = "Move the given display object towards the x/y coordinates at a steady velocity. If you specify a maxTime then it will adjust the speed (over-writing what you set) so it arrives at the destination in that number of seconds. Timings are approximate due to the way browser timers work. Allow for a variance of +- 50ms. Note: The display object does not continuously track the target. If the target changes location during transit the display object will not modify its course. Note: The display object doesn't stop moving once it reaches the destination coordinates. Note: Doesn't take into account acceleration, maxVelocity or drag (if you've set drag or acceleration too high this object may not move at all)";  // untranslated
...
Blockly.Msg.PHYSICS_MOVE_TO_POINTER_TOOLTIP = "Move the given display object towards the pointer at a steady velocity. If no pointer is given it will use Phaser.Input.activePointer. If you specify a maxTime then it will adjust the speed (over-writing what you set) so it arrives at the destination in that number of seconds. Timings are approximate due to the way browser timers work. Allow for a variance of +- 50ms. Note: The display object does not continuously track the target. If the target changes location during transit the display object will not modify its course. Note: The display object doesn't stop moving once it reaches the destination coordinates.";  // untranslated
...
Blockly.Msg.SET_ANIMATION_BOOLEAN_FIELD_VI_HELP_URL = "https://photonstorm.github.io/phaser-ce/Phaser.Animation.html";  // untranslated
...
Blockly.Msg.SET_ANIMATION_NUMERIC_FIELD_HELP_URL = "https://photonstorm.github.io/phaser-ce/Phaser.Animation.html";  // untranslated
...
Blockly.Msg.SET_ANIMATION_STRING_FIELD_HELP_URL = "https://photonstorm.github.io/phaser-ce/Phaser.Animation.html";  // untranslated
