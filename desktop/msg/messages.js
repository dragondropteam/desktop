...
Blockly.Msg.PHYSICS_ACCELERATE_TO_LOCATION_TOOLTIP = '';
Blockly.Msg.PHYSICS_ACCELERATE_TO_LOCATION_HELP_URL = '';
Blockly.Msg.PHYSICS_ACCELERATE_TO_POINTER_TOOLTIP = '';
Blockly.Msg.PHYSICS_ACCELERATE_TO_POINTER_HELP_URL = '';
...
Blockly.Msg.PHYSICS_DISTANCE_TO_LOCATION_TOOLTIP = 'Find the distance between a display object (like a Sprite) and the given x/y coordinates. The calculation is made from the display objects x/y coordinate. This may be the top-left if its anchor hasn\'t been changed. If you need to calculate from the center of a display object instead use the method distanceBetweenCenters()';
...
Blockly.Msg.COLLISION_GET_OBJECTS_AT_LOCATION_FUNCTION_TOOLTIP = 'Given a Group and a location this will check to see which Group children overlap with the coordinates. Each child will be sent to the given callback for further processing. Note that the children are not checked for depth order, but simply if they overlap the coordinate or not.';
...
Blockly.Msg.GET_OBJECTS_UNDER_POINTER_TOOLTIP = 'Given a Group and a Pointer this will check to see which Group children overlap with the Pointer coordinates. Each child will be sent to the given callback for further processing. Note that the children are not checked for depth order, but simply if they overlap the Pointer or not.';
...
Blockly.Msg.CHECK_COLLISION_TOOLTIP = 'Which edges of the World bounds Bodies can collide against when collideWorldBounds is true. For example checkCollision.down = false means Bodies cannot collide with the World.bounds.bottom. An object containing allowed collision flags (up, down, left, right).';
