...
/**
 * File Modified by DigiPen Institute of Technology
 *
 * All modifications copyright DigiPen 2016
 *
 * START MODIFICATIONS
 */
 ...
 * This modification will allow for setting functionTypes, prevent code duplication
 * and complication compared to putting this in a Blockly.VariablesTyped
 * @param {!Blockly.Workspace} workspace The workspace containing variables.
 * @return {!Array.<!Element>} Array of XML block elements.
 */
Blockly.Variables.flyoutCategoryTyped = function(workspace) {
  ...
  var fieldType, typeMutation, type_;
  ...
  if (variableList.length > 0) {
    if (Blockly.Blocks['variables_set']) {
      ...
      fieldType = workspace.getVariableType(variableList[0]);

      typeMutation = goog.dom.createDom('mutation');
      type_ = 'Number';
      ...
      typeMutation.setAttribute('type', type_);
      typeMutation.setAttribute('ctype', fieldType);

      var block = goog.dom.createDom('block');
      block.appendChild(typeMutation);
      block.setAttribute('type', 'variable_set_typed');
    ...
    /**
     * Modification, used typed block from Dragon Drop copyright DigiPen Institute of Technology
     */
    for (var i = 0; i < variableList.length; i++) {
      if (Blockly.Blocks['variables_get']) {
        ...
        fieldType = workspace.getVariableType(variableList[i]);
        ...
        var fieldType = workspace.getVariableType(variableList[i]).toLowerCase();
        var typeField = goog.dom.createDom('field', null, fieldType);
        typeField.setAttribute('name', 'TYPELOWER');
