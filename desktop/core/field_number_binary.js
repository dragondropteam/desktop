...
goog.provide('Blockly.FieldNumberBinary');
 ...
 * @constructor
 */
Blockly.FieldNumberBinary =
    function (value, opt_min, opt_max, opt_precision, opt_validator) {
        value = String(value);
        Blockly.FieldNumberBinary.superClass_.constructor.call(this, value, opt_validator);
        this.setConstraints(opt_min, opt_max, opt_precision);
    };

goog.inherits(Blockly.FieldNumberBinary, Blockly.FieldTextInput);
 ...
 */
Blockly.FieldNumberBinary.prototype.setConstraints = function (min, max, precision) {
 ...
 */
Blockly.FieldNumberBinary.prototype.classValidator = function (text) {
    if (text === null) {
        return null;
    }
    text = String(text);
