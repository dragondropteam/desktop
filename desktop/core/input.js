...
/**
 * Modifications to add strict to connection checking added by
 * DigiPen Institute of Technology 2017
 * @author Luke Powell
 */
 ...
 *     list of value functionTypes.  Null if all functionTypes are compatible.
 * @param strict Pass through for strictness
 * @return {!Blockly.Input} The input being modified (to allow chaining).
 */
Blockly.Input.prototype.setCheck = function (check, strict) {
  if (!this.connection) {
    throw 'This input does not have a connection.';
  }
    this.connection.setCheck(check, strict);
  return this;
};
