...
Blockly.Flyout.prototype.show = function (xmlList) {
    ...
    } else if (xmlList == Blockly.Variables.NAME_TYPE_ICON) {
        xmlList = Blockly.Variables.flyoutCategoryIcon(this.workspace_.targetWorkspace);
    } else if (xmlList == Blockly.Procedures.NAME_TYPE) {
        // Special category for procedures.
        xmlList = Blockly.Procedures.flyoutCategory(this.workspace_.targetWorkspace);
    } else if (xmlList == Blockly.Procedures.NAME_TYPE_ICON) {
        xmlList = Blockly.Procedures.flyoutCategoryIcon(this.workspace_.targetWorkspace);
    }
    //Typed versions of variables and procedures added by DigiPen Institute of technology 2016
    else if (xmlList == Blockly.Variables.TYPED_VARIABLES_NAME_TYPE) {
        xmlList =
            Blockly.Variables.flyoutCategoryTyped(this.workspace_.targetWorkspace);
    } else if (xmlList == Blockly.Procedures.TYPED_PROCEDURES_NAME_TYPE) {
        xmlList =
            Blockly.Procedures.flyoutCategoryTyped(this.workspace_.targetWorkspace);
    } else if (xmlList == DragonDrop.Classes.NAME_TYPE) {
        xmlList = DragonDrop.Classes.flyoutCategory(this.workspace_.targetWorkspace);
    }
