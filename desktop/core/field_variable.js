...
/**
 * Additional methods related to typing copyright DigiPen Institute of Technology 2016
 */
Blockly.FieldVariable.prototype.setType = function(type){
  this.type_ = type;
};

Blockly.FieldVariable.prototype.getType = function(){
  return this.type_ || 'Number';
};

Blockly.FieldVariable.prototype.setCType = function(cType){
  this.cType = cType;
  if(this.sourceBlock_ && this.sourceBlock_.cType){
    this.sourceBlock_.cType = cType;
  }
};

Blockly.FieldVariable.prototype.getCType = function(){
  return (this.cType || this.sourceBlock_.cType) || 'INTEGER';
};
/**
 * End additions
 */
